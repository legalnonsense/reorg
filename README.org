...
But, we have the next best thing because you can also customize the bullets for the headers using the =:bullet= keyword but I don't feel like getting into that. 
**** :sort-results
