...
** Using Reorg without custom modules
#+begin_src emacs-lisp :results silent
(reorg-create-class-type
 :name json
...
This is a hobby. I am a lawyer and not a programmer. I rushed to publish this because my work is about to ramp up and my free time disappear. I do not know if it will continue once I get this past the point that it is ready for me to use on a daily basis. Further development depends on reception. If you think this is useful please let me know. 
** Planned features  
*** Changing views on the fly
**** Hoisting headings / Inverting the outline / multiple views 
**** Infinite outlines (not sure what I meant by this but sounds interesting)
